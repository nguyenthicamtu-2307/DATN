...
import com.example.foryou.databinding.ActivitySubscriptonListImageBinding
...
class SubscriptonInforLocal : AppCompatActivity(), OnReliefClick {
    private lateinit var binding :ActivitySubscriptonListImageBinding
    private lateinit var recyclerView: RecyclerView
    private lateinit var adapterView :ReliefRescueAdapter
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding= ActivitySubscriptonListImageBinding.inflate(layoutInflater)
            ...
            override fun onResponse(call: Call<ReliefList>, response: Response<ReliefList>) {
                if (response.isSuccessful){
                    ...
                    recyclerView.layoutManager =
                        LinearLayoutManager(this@SubscriptonInforLocal, LinearLayoutManager.VERTICAL, false)
                    dataList?.data?.toMutableList()?.let { adapterView.replaceDatRelife(it) }
                    adapterView.addRelief(this@SubscriptonInforLocal)
    ...
    override fun onItemClick(dataItem: DataItemRelief) {
        ...
        var intent = Intent(this,InforAidRescue::class.java)
